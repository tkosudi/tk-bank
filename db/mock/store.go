...
func (m *MockStore) CreateTransfers(ctx context.Context, arg db.CreateTransfersParams) (db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfers(ctx context.Context, id int64) (db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetTransfers(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
